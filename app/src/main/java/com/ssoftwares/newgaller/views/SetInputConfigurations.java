...
public class SetInputConfigurations extends BaseActivity {

    private static final String TAG = "SetInputConfigurations";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Input Configurations");
        ...
        adapter = new InputsAdapter(this , inputConfigs , false);
    ...
    private void getInputConfig() throws IOException {
        ...
        byte[] command = MyUtils.stringTobytes(Commands.CMD_GET_INPUT_CONFIG);
    ...
    private void setInputConfig() throws IOException {
        ...
        byte[] command = MyUtils.stringTobytes(Commands.CMD_SET_INPUT_CONFIG);
        outputStream.write(command);
