...
public class SetNtpServer extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_ntp_ipv6);
        mHandler = new MyHandler(this);

        getSupportActionBar().setTitle("Set Network Time Protocol Server");
    ...
    private void readResponse(byte[] data) {
        ...
        switch (status) {
            case Constants.SUCCESS:
                dialog.dismiss();
                Toast.makeText(this, "NTP Server changed successfully", Toast.LENGTH_SHORT).show();
